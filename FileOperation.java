...
{try{ 
if(set==1)
	{Permissions readperm = new ReadPermission();
	readperm.setPerm(temp);}
	//temp.setWritable(false);
else
{
	Permissions writeperm = new WritePermissionsDecorator(new ReadPermission());
	writeperm.setPerm(temp);}
